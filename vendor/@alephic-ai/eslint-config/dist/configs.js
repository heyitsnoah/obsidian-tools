...
import { typedEslintRules, untypedEslintRules, } from './rules/typescript-eslint-rules.js';
    ...
    const output = [
        ...
        // Default config
        {
            ...
            languageOptions: {
                parser,
                parserOptions: {
                    warnOnUnsupportedTypeScriptVersion: props.warnOnUnsupportedTypeScriptVersion ?? false,
                },
                sourceType: 'module',
            },
            linterOptions: {
            ...
            }, // @typescript-eslint's linter options are out of date with eslint's
